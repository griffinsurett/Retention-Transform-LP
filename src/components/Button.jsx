...
export default function Button({
  ...
  return (
    <Component
      ...
      className={`${classname} cursor-pointer bg-primary text-white px-4 py-3 border-2 border-primary rounded-full text-xl transition-opacity duration-200 hover:opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary`}
      {...roleProps}
      {...props}
    >
      {children}
